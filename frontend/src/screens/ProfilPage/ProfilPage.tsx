      ...
      <div className="div-2">
        ...
        <div className="page-content">
            ...
            <WyzwanieMiejskie
              ...
              text1={
                <>
                  ...
                  Twoim zadaniem będzie utworzenie skryptu, łączącego dane z wszystkich punktów pomiaru pogody na
                  obszarze gminy, pogrupowanych tygodniami i przygotowanie analizy na ich podstawie...
                </>
              }
            />
          </div>
          <div className="profil-page-right">
            ...
            />
            <QuestMap className="design-component-instance-node-5" iconForward="/img/icon-forward-10-seconds-1.png" />
          </div>
        </div>
      </div>
    </div>
